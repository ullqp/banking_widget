...
from src.generators import filter_rub_transactions
...
def main():
    ...
    path_to_java = "data/operations.json"
    path_to_csv = "data/transactions.csv"
    path_to_xlsx = "data/transactions.xlsx"
...
Доступные для фильтровки статусы: EXECUTED, CANCELED, PENDING\n\n"""
    ...
    operations = filter_by_state(operations, state=selected_status.upper())
    ...
    try:
        if selected_sorted["sort_date"]:
            operations = sort_by_date(operations, reverse=selected_sorted["reverse"])

        if selected_sorted["only_rub"]:
            operations = list(filter_rub_transactions(operations, file_to_open))
