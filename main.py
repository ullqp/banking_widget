...
from src.utils import read_csv, read_excel, read_java
...
while not success:
    user_answer = input("""Выберите необходимый пункт меню:
...
if selected_menu == '1':
    operations = read_java(path_to_java)
...
try:
    print(selected_sorted['sort_date'])
    if selected_sorted['sort_date']:
